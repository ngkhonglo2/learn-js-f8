...
function Validator(options){
    ...
    function validate (inputElement, rule){
        ...
        // value: lấy từ inputElement.value
                // test func: lấy từ rule.test
...
Validator.MinLenght = function(selector, min, Message){
    return {
        selector: selector,
        test: function(value){
            return value.length >= min ? undefined : Message || `nhập đủ ${min} kí tự`;
        }
    }
};
...
Validator.isConfirmed = function(selector, getConfirmValue, Message){
    return{
        selector: selector,
        test: function(value){
            return value === getConfirmValue() ? undefined : Message || 'Nhập mật khẩu không đúng';
        }
    }
}